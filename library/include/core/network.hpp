...
namespace core::network {
    using NetworkGeneratorFunction = core::types::NetworkGeneratorFunction;
    using KernelInitializerFunction = core::types::KernelInitializerFunction;
    using WeightInitializerFunction = core::types::WeightInitializerFunction;

    using NeuronId = core::types::NeuronId;
    using Neuron   = core::types::Neuron;
    using Synapse  = core::types::Synapse;

    using NeuronList = core::types::NeuronList;
    using SynapseList = core::types::SynapseList;
